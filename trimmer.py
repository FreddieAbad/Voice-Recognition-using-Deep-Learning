...
for input_wavfile in os.listdir(read_path):
    ...
    # Output file
    print(">>>>",write_path + input_wavfile)
    ...
    for i in range(0, LEN):
        ...
        #print("VVVV: ",sys.getsizeof(input_string), ' :::', input_string.nbytes)
        input_tuple = struct.unpack('c', input_string)
        output_value = input_tuple[0]

        # Save the wave file
        output_string = struct.pack('c', output_value)
        output_wf.writeframes(output_string)
